...
if (!firebase.apps.length) {
  firebase.initializeApp({
    apiKey:
      process.env.FIREBASE_API_KEY || process.env.STORYBOOK_FIREBASE_API_KEY || process.env.REACT_APP_FIREBASE_API_KEY,
    authDomain:
      process.env.FIREBASE_AUTH_DOMAIN ||
      process.env.STORYBOOK_FIREBASE_AUTH_DOMAIN ||
      process.env.REACT_APP_FIREBASE_AUTH_DOMAIN,
    databaseURL:
      process.env.FIREBASE_DB_URL || process.env.STORYBOOK_FIREBASE_DB_URL || process.env.REACT_APP_FIREBASE_DB_URL,
    projectId:
    ...
    appId:
      process.env.FIREBASE_APP_ID || process.env.STORYBOOK_FIREBASE_APP_ID || process.env.REACT_APP_FIREBASE_APP_ID,
    measurementId:
